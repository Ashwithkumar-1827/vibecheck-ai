...
export default function RepoCard({ repo, onRun, onDelete, actionLabel = 'Run Pipeline', actionIcon = null }) {
  ...
  return (
    <div className="bg-white border border-zinc-200/80 dark:bg-zinc-950 dark:border-zinc-900 rounded-2xl p-5 hover:border-zinc-350 dark:hover:border-zinc-800 transition-all duration-200 group/repocard shadow-sm relative flex flex-col justify-between">
      ...
      <div>
        ...
        {/* Specs and info */}
        <div className="grid grid-cols-2 gap-3.5 my-5 border-t border-b border-zinc-100 dark:border-zinc-900/85 py-4">
      ...
      <div className="flex items-center space-x-2.5 mt-2">
        <button
          ...
          className="flex-1 py-2 bg-zinc-950 hover:bg-zinc-900 disabled:opacity-50 dark:bg-white dark:hover:bg-zinc-150 text-white dark:text-zinc-950 text-[10px] font-mono font-bold uppercase tracking-wider rounded-xl flex items-center justify-center gap-1.5 transition-all active:scale-98"
        >
        ...
        <button
          onClick={onDelete}
          className="p-2 text-zinc-450 hover:text-red-500 hover:bg-red-500/10 border border-zinc-200 dark:border-zinc-900 dark:hover:border-red-500/25 rounded-xl transition-all"
